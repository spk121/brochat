...
// Declare an enum for CSRF validation results
enum CsrfValidationResult {
    case UNSET;
    case EXPIRED;
    case VALID;
    case INVALID;
...
// Function to validate CSRF token from POST data
function validateCsrfFromPost(): CsrfValidationResult {
    if (!isset($_SESSION['csrf_token'])) {
        return CsrfValidationResult::UNSET;
    }
    ...
    if (time() - ($_SESSION['csrf_token_time'] ?? 0) > CSRF_TOKEN_TIMEOUT) {
